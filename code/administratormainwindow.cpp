...
AdministratorMainWindow::AdministratorMainWindow(CCIMS* c, QWidget *parent) :
    QMainWindow(parent),
...
{
    AdministratorLeadWindow *mALW = new AdministratorLeadWindow(mCCIMS,this);
...
void AdministratorMainWindow::on_WorkButton_clicked()
{
    ...
    //产生界面
    AdministratorSCWindow *mASCW = new AdministratorSCWindow(mCCIMS,this);
